...
public class Game extends JFrame implements Runnable , MouseMotionListener , MouseListener {
	...
	public Game() 
	{
		...
		this.setSize(400, 620);//Remember Size of window
		this.setTitle("Lane Keeper");// Title of Game
	...
	public void paint(Graphics g) {
		...
		if(f4==1)
		{
			...
			g.drawString("Accident...."+score, 80, 300);
		}
		else if(f4 == 2)
		{
			n = 100;
			...
			g.setFont(new Font("Ariel", Font.BOLD, 30));
			g.setColor(Color.RED);
			g.drawString("You struck the Edge..."+score, 40, 300);
		}
	...
	public void mouseMoved(MouseEvent e) {
		...
		{
			xm = e.getX(); //stores mouse position
			ym = e.getY();
	}	}
